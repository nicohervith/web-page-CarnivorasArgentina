        ...
        <div className="card-sup1">
          <div className="card-text1">
            <p className="card-text-p">
              Soy Federico Ezequiel Parrilli. Nací en Buenos Aires y la jungla
              de cemento me incentivó a llenar de verde cada espacio que pude.
              Primero, con cualquier planta que haga fotosíntesis y después con
              un notorio enfoque en las especies nativas. Hoy vivo en Puerto
              Madryn, Chubut.
            </p>
            <p className="card-text-p">
        ...
        <div className="card-sup1">
          <div className="card-text1">
            <p className="card-text-p">
              ...
              Altos Estudios en Ciencias Exactas (CAECE); Diplomado en la
              Gestión Integral del Cambio Climático y Diplomado en Derecho
              ambiental y Gestión de Áreas Naturales Protegidas. Tuve la suerte
              de dar charlas y capacitar en Instituciones públicas como la
              Administración de Parques Nacionales (APN), el Museo Argentino de
              Ciencias Naturales Bernardino Rivadavia (MACN), el Instituto
              Nacional de Tecnología Agropecuaria (INTA) y el Jardín Botánico
              Carlos Thays de la Ciudad Autónoma de Buenos Aires.
            </p>
            <p className="card-text-p">
              También en Universidades como la Universidad de Buenos Aires (UBA)
              y la Universidad Autónoma de Chiriquí (UNACHI) y en ONGs como Aves
              Argentinas (AA) y la Sociedad Argentina de Horticultura (SAH).
            </p>
            <div class="card-sup-me2">
              <img src={me2} class="card-img" alt="..." />
            </div>
          </div>
        </div>
